<script lang="ts">
  import {Button, Input, Modal, Select, Table, TableBody, TableBodyCell, TableBodyRow, TableHead, TableHeadCell} from "flowbite-svelte";
  ...
  const categories = ["Food", "Transportation", "Entertainment", "Shopping", "Utilities", "Housing", "Healthcare", "Education", "Personal", "Other"];
  ...
  <div class="space-y-6">
    ...
    <Table border={true} shadow={true} striped={true}>
      ...
      <TableBody>
        ...
        <TableBodyRow>
          <TableBodyCell>
            <Input bind:value={newItem.timestamp} class="w-full" placeholder="Time" type="time"/>
          </TableBodyCell>
          <TableBodyCell>
            <Input bind:value={newItem.name} class="w-full" placeholder="Item name" required type="text"/>
          </TableBodyCell>
          <TableBodyCell>
            <Select bind:value={newItem.category} class="w-full" required>
          ...
          <TableBodyCell>
            <Input bind:value={newItem.amount} class="w-full" placeholder="0.00" required step="0.01" type="number"/>
          </TableBodyCell>
          <TableBodyCell>
            <Input bind:value={newItem.description} class="w-full" placeholder="Description" type="text"/>
          </TableBodyCell>
          <TableBodyCell>
